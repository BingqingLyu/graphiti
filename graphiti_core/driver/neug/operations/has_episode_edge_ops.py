...
from graphiti_core.driver.neug.parsers import has_episode_edge_from_record
...
class NeuGHasEpisodeEdgeOperations(HasEpisodeEdgeOperations):
    async def save(
        self,
    ...
    async def get_by_uuid(
        ...
        edges = [has_episode_edge_from_record(r) for r in records]
        if len(edges) == 0:
    ...
    async def get_by_uuids(
        ...
        return [has_episode_edge_from_record(r) for r in records]
